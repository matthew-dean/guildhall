...
- `internal/plans/archive/2026-05-24-guildhall-0-8-git-story-closure.md` is the
  detailed implementation plan for the 0.8.0 Git Story Closure blocker.
- `internal/plans/archive/2026-05-24-task-schema-runtime-evidence-split.md` is the
