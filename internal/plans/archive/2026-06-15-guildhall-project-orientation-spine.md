...
- `internal/plans/archive/specs/2026-06-05-guildhall-0-10-primitives-and-delivery-spine.md`: historical delivery-spine implementation context; the active pivot removes the separate spine concept.
- `internal/plans/archive/specs/2026-06-12-guildhall-logical-work-and-delivery-steps.md`: historical work/step implementation context; the active pivot treats hierarchy as fields and views over project state.
