...
export const MODEL_CATALOG: ModelCatalogEntry[] = [
  ...
  },
  {
    ...
    structuredOutput: 2,
    speed: 2,
    inputPricePerMillionUsd: 0.74,
    outputPricePerMillionUsd: 3.50,
    cachedInputPricePerMillionUsd: 0.15,
    recommendedRoles: ['worker', 'spec', 'coordinator', 'reviewer'],
    notes: 'DeepInfra-hosted Kimi coding challenger. Use for live bakeoffs against the cheaper DeepSeek and Qwen lanes; do not confuse it with Kimi K3, which is not currently hosted by DeepInfra.',
  },
  {
