...
- Did I review the small strings too — nav, tabs, buttons, chips, badges,
  status labels, settings labels, tooltips, headings, and page titles?
...
- Public docs that say "agents should," "the human," or "human input" when
  they mean "Guildhall asks you" or "you decide."
