...
The importer detects recognized shapes — e.g. a `specs/` folder, a `TASKS.md` markdown backlog, or an external issue tracker export — and translates them into reviewable task candidates.
