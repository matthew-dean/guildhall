...
help_summary: |
  ...
  to you; `coordinator_first` (default) tries the coordinator agent
...
| Position | Behavior |
|---|---|
| `always` | Worker raises an escalation for you; work pauses. |
| `coordinator_first` | Worker asks its domain coordinator. If the coordinator can resolve (within `autonomousDecisions`), work continues. Otherwise it asks you. |
