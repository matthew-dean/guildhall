...
2026-05-11, not on older docs assumptions.
...
- `docs/assets/ui-audit/coordinators.png`
- `docs/assets/ui-audit/timeline.png`
- `docs/assets/ui-audit/release.png`
- `docs/assets/ui-audit/settings.png`
- `docs/assets/ui-audit/providers.png`
- `docs/assets/ui-audit/task-drawer.png`
...
The current shell is a single-project application with these primary routes:
...
This matters because the current docs/story work has been talking about a
Projects page and multi-project service home. That may still be the product
direction, but it is not the reality of this worktree's live UI. The redesign
should treat that as product/docs drift, not paper over it.
