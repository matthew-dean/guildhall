...
Press **Start** once the task is clear enough to judge. You should see live
movement in the shell: the task changing state, notes appearing, checks or
review evidence accumulating, and any blocker attached to the project.
