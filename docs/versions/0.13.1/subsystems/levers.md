...
help_summary: |
  ...
  positions, persisted in ./.guildhall/agent-settings.yaml with who-set-it, when,
...
**Source:** `./src/levers/`
**Storage:** `./.guildhall/agent-settings.yaml`
...
- The browser Settings tab exposes every lever with a `?` icon that links back here.
