...
This is the version-pinned docs snapshot for Guildhall 0.11.0. The public docs root defaults to this latest published release; unreleased main-branch docs live under [Next](/next/guide/).
